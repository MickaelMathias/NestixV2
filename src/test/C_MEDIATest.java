...
public class C_MEDIATest {
	...
	@Test
	//Cr�ation et suppression de media
	...
	@Test
	//Pas de doublons ann�e/titre/type
	...
	/*
	@Test
	//V�rification de la concat�nation de media_link pour ne pas d�passer 255 caract�res
	public void testLength() {
		String str = "abcde";
		String longStr = str.repeat(53); //5*53 = 265 caract�res
