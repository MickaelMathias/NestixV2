...
public void gestionClicBoutonsCreationFilm(){
    mon_panel_container_creation.mon_panel_creation_film.b_creation_film_valider_creation.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
        	...
        	objets.C_FILM mon_film_a_creer;
            ...
            else if (mon_film_a_creer.verifExistenceMedia()!=-1) {
            	javax.swing.JOptionPane.showMessageDialog(mon_panel_container_creation, "Ce film existe d�j�");
            }
            else{
  ...
  //Laure
    ...
    mon_panel_container_creation.mon_panel_creation_film.b_creation_film_ajouter_genre.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            if (!mon_panel_container_creation.mon_panel_creation_film.cb_creation_film_genres.getSelectedItem().toString().equals("Choisissez")){
                ...
                JOptionPane.showMessageDialog(mon_panel_container_creation, "Veuillez d'abord selectionner un genre");
            }}
    });
    mon_panel_container_creation.mon_panel_creation_film.b_creation_film_ajouter_tag.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
        	if (!mon_panel_container_creation.mon_panel_creation_film.cb_creation_film_tags.getSelectedItem().toString().equals("Choisissez")){
                ...
                JOptionPane.showMessageDialog(mon_panel_container_creation, "Veuillez d'abord selectionner un tag");
            }}
    });
...
public void gestionClicBoutonsCreationLivre(){
    ...
    mon_panel_container_creation.mon_panel_creation_livre.b_creation_livre_creer_artiste.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nickname = JOptionPane.showInputDialog(mon_panel_container_creation.mon_panel_creation_livre, "Donnez un surnom à l'artiste.");
            System.out.println(nickname);
            if (!nickname.equals(null)){
            mon_panel_container_creation.mon_panel_creation_livre.creerArtisteVolee(nickname);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT artist_nickname FROM artist", "artist_nickname", mon_panel_container_creation.mon_panel_creation_livre.cb_creation_livre_artiste);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_creation, "Artiste bien ajouté aux brouillons");}
        }
    });
    mon_panel_container_creation.mon_panel_creation_livre.b_creation_livre_creer_genre.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nom_genre = JOptionPane.showInputDialog(mon_panel_container_creation.mon_panel_creation_livre, "Donnez un nom au genre.");
            if (!nom_genre.equals(null)){
            mon_panel_container_creation.mon_panel_creation_livre.creerCaracteristiqueVolee("genre",nom_genre);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT genre_name FROM genre", "genre_name", mon_panel_container_creation.mon_panel_creation_livre.cb_creation_livre_genres);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_creation, "Genre bien ajouté");}
        }
    });
    mon_panel_container_creation.mon_panel_creation_livre.b_creation_livre_creer_tag.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nom_tag = JOptionPane.showInputDialog(mon_panel_container_creation.mon_panel_creation_livre, "Donnez un nom au tag ?");
            if (!nom_tag.equals(null)){
            mon_panel_container_creation.mon_panel_creation_livre.creerCaracteristiqueVolee("tag",nom_tag);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT tag_name FROM tag", "tag_name", mon_panel_container_creation.mon_panel_creation_livre.cb_creation_livre_tags);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_creation, "Tag bien ajouté");}
        }
    });
    mon_panel_container_creation.mon_panel_creation_livre.b_creation_livre_creer_ceremonie.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nom_ceremonie = JOptionPane.showInputDialog(mon_panel_container_creation.mon_panel_creation_livre, "Donnez un nom à la cérémonie ?");
            if (!nom_ceremonie.equals(null)){
            mon_panel_container_creation.mon_panel_creation_livre.creerCaracteristiqueVolee("ceremony",nom_ceremonie);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT ceremony_name FROM ceremony", "ceremony_name", mon_panel_container_creation.mon_panel_creation_livre.cb_creation_livre_ceremonie);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_creation, "Ceremoniée bien ajoutée");}
        }
    });
    mon_panel_container_creation.mon_panel_creation_livre.b_creation_livre_creer_award.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nom_award = JOptionPane.showInputDialog(mon_panel_container_creation.mon_panel_creation_livre, "Donnez un nom à la récompense ?");
            if (!nom_award.equals(null)){
            mon_panel_container_creation.mon_panel_creation_livre.creerCaracteristiqueVolee("award",nom_award);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT award_name FROM award", "award_name", mon_panel_container_creation.mon_panel_creation_livre.cb_creation_livre_award);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_creation, "Récompense bien ajoutée");}
        }
    });
    //Laure
    mon_panel_container_creation.mon_panel_creation_livre.b_creation_livre_creer_studio_production.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nom_pc = JOptionPane.showInputDialog(mon_panel_container_creation.mon_panel_creation_livre, "Donnez un nom � l'�diteur.");
            if (!nom_pc.equals(null)){
            mon_panel_container_creation.mon_panel_creation_livre.creerCaracteristiqueVolee("pc",nom_pc);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT pc_name FROM pc", "pc_name", mon_panel_container_creation.mon_panel_creation_livre.cb_creation_livre_studio_production);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_creation, "Editeur bien ajout�");}
        }
    });
    mon_panel_container_creation.mon_panel_creation_livre.b_creation_livre_ajouter_ecrivain.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
        	if (!mon_panel_container_creation.mon_panel_creation_livre.cb_creation_livre_artiste.getSelectedItem().toString().equals("Choisissez")){
                ...
                JOptionPane.showMessageDialog(mon_panel_container_creation, "Veuillez d'abord selectionner un �crivain");
            }}
    });
    mon_panel_container_creation.mon_panel_creation_livre.b_creation_livre_ajouter_genre.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
        	if (!mon_panel_container_creation.mon_panel_creation_livre.cb_creation_livre_genres.getSelectedItem().toString().equals("Choisissez")){
    ...
    mon_panel_container_creation.mon_panel_creation_livre.b_creation_livre_ajouter_tag.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
        	if (!mon_panel_container_creation.mon_panel_creation_livre.cb_creation_livre_tags.getSelectedItem().toString().equals("Choisissez")){
...
public void gestionClicBoutonsCreationChanson(){
    ...
    mon_panel_container_creation.mon_panel_creation_chanson.b_creation_chanson_creer_artiste.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nickname = JOptionPane.showInputDialog(mon_panel_container_creation.mon_panel_creation_chanson, "Donnez un surnom à l'artiste.");
            System.out.println(nickname);
            if (!nickname.equals(null)){
            mon_panel_container_creation.mon_panel_creation_chanson.creerArtisteVolee(nickname);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT artist_nickname FROM artist", "artist_nickname", mon_panel_container_creation.mon_panel_creation_chanson.cb_creation_chanson_artiste);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_creation, "Artiste bien ajouté aux brouillons");}
        }
    });
    mon_panel_container_creation.mon_panel_creation_chanson.b_creation_chanson_creer_genre.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nom_genre = JOptionPane.showInputDialog(mon_panel_container_creation.mon_panel_creation_chanson, "Donnez un nom au genre.");
            if (!nom_genre.equals(null)){
            mon_panel_container_creation.mon_panel_creation_chanson.creerCaracteristiqueVolee("genre",nom_genre);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT genre_name FROM genre", "genre_name", mon_panel_container_creation.mon_panel_creation_chanson.cb_creation_chanson_genres);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_creation, "Genre bien ajouté");}
        }
    });
    mon_panel_container_creation.mon_panel_creation_chanson.b_creation_chanson_creer_tag.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nom_tag = JOptionPane.showInputDialog(mon_panel_container_creation.mon_panel_creation_chanson, "Donnez un nom au tag ?");
            if (!nom_tag.equals(null)){
            mon_panel_container_creation.mon_panel_creation_chanson.creerCaracteristiqueVolee("tag",nom_tag);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT tag_name FROM tag", "tag_name", mon_panel_container_creation.mon_panel_creation_chanson.cb_creation_chanson_tags);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_creation, "Tag bien ajouté");}
        }
    });
    mon_panel_container_creation.mon_panel_creation_chanson.b_creation_chanson_creer_ceremonie.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nom_ceremonie = JOptionPane.showInputDialog(mon_panel_container_creation.mon_panel_creation_chanson, "Donnez un nom à la cérémonie ?");
            if (!nom_ceremonie.equals(null)){
            mon_panel_container_creation.mon_panel_creation_chanson.creerCaracteristiqueVolee("ceremony",nom_ceremonie);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT ceremony_name FROM ceremony", "ceremony_name", mon_panel_container_creation.mon_panel_creation_chanson.cb_creation_chanson_ceremonie);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_creation, "Ceremoniée bien ajoutée");}
        }
    });
    mon_panel_container_creation.mon_panel_creation_chanson.b_creation_chanson_creer_award.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nom_award = JOptionPane.showInputDialog(mon_panel_container_creation.mon_panel_creation_chanson, "Donnez un nom à la récompense ?");
            if (!nom_award.equals(null)){
            mon_panel_container_creation.mon_panel_creation_chanson.creerCaracteristiqueVolee("award",nom_award);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT award_name FROM award", "award_name", mon_panel_container_creation.mon_panel_creation_chanson.cb_creation_chanson_award);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_creation, "Récompense bien ajoutée");}
        }
    });
    mon_panel_container_creation.mon_panel_creation_chanson.b_creation_chanson_creer_studio_production.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nom_pc = JOptionPane.showInputDialog(mon_panel_container_creation.mon_panel_creation_chanson, "Donnez un nom au label.");
            if (!nom_pc.equals(null)){
            mon_panel_container_creation.mon_panel_creation_chanson.creerCaracteristiqueVolee("pc",nom_pc);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT pc_name FROM pc", "pc_name", mon_panel_container_creation.mon_panel_creation_chanson.cb_creation_chanson_studio_production);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_creation, "Label bien ajout�");}
        }
    });
    mon_panel_container_creation.mon_panel_creation_chanson.b_creation_chanson_creer_groupe.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nom_groupe = JOptionPane.showInputDialog(mon_panel_container_creation.mon_panel_creation_chanson, "Donnez un nom au groupe.");
            if (!nom_groupe.equals(null)){
            mon_panel_container_creation.mon_panel_creation_chanson.creerCaracteristiqueVolee("band",nom_groupe);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT band_name FROM band", "band_name", mon_panel_container_creation.mon_panel_creation_chanson.cb_creation_chanson_groupe);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_creation, "Groupe bien ajout�");}
        }
    });
    mon_panel_container_creation.mon_panel_creation_chanson.b_creation_chanson_ajouter_interprete.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
        	if (!mon_panel_container_creation.mon_panel_creation_chanson.cb_creation_chanson_artiste.getSelectedItem().toString().equals("Choisissez")){
    ...
    mon_panel_container_creation.mon_panel_creation_chanson.b_creation_chanson_ajouter_genre.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
        	if (!mon_panel_container_creation.mon_panel_creation_chanson.cb_creation_chanson_genres.getSelectedItem().toString().equals("Choisissez")){
    ...
    mon_panel_container_creation.mon_panel_creation_chanson.b_creation_chanson_ajouter_tag.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
        	if (!mon_panel_container_creation.mon_panel_creation_chanson.cb_creation_chanson_tags.getSelectedItem().toString().equals("Choisissez")){
...
public void gestionClicBoutonsCreationArtiste(){
    ...
    mon_panel_container_creation.mon_panel_creation_artiste.b_creation_artiste_creer_pays.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nom_pays = JOptionPane.showInputDialog(mon_panel_container_creation.mon_panel_creation_artiste, "Quel est le pays?");
            if (!nom_pays.equals(null)){
            mon_panel_container_creation.mon_panel_creation_artiste.creerCaracteristiqueVolee("country",nom_pays);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT country_name FROM country", "country_name", mon_panel_container_creation.mon_panel_creation_artiste.cb_creation_artiste_pays);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_creation, "Pays bien ajouté");}
        }
    });
    mon_panel_container_creation.mon_panel_creation_artiste.b_creation_artiste_creer_ceremonie.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nom_ceremonie = JOptionPane.showInputDialog(mon_panel_container_creation.mon_panel_creation_artiste, "Donnez un nom à la cérémonie ?");
            if (!nom_ceremonie.equals(null)){
            mon_panel_container_creation.mon_panel_creation_artiste.creerCaracteristiqueVolee("ceremony",nom_ceremonie);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT ceremony_name FROM ceremony", "ceremony_name", mon_panel_container_creation.mon_panel_creation_artiste.cb_creation_artiste_ceremonie);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_creation, "Ceremoniée bien ajoutée");}
        }
    });
    mon_panel_container_creation.mon_panel_creation_artiste.b_creation_artiste_creer_award.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nom_award = JOptionPane.showInputDialog(mon_panel_container_creation.mon_panel_creation_artiste, "Donnez un nom à la récompense ?");
            if (!nom_award.equals(null)){
            mon_panel_container_creation.mon_panel_creation_artiste.creerCaracteristiqueVolee("award",nom_award);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT award_name FROM award", "award_name", mon_panel_container_creation.mon_panel_creation_artiste.cb_creation_artiste_award);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_creation, "Récompense bien ajoutée");}
        }
    });
    mon_panel_container_creation.mon_panel_creation_artiste.b_creation_artiste_creer_groupe.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nom_groupe = JOptionPane.showInputDialog(mon_panel_container_creation.mon_panel_creation_artiste, "Donnez un nom au groupe.");
            if (!nom_groupe.equals(null)){
            mon_panel_container_creation.mon_panel_creation_artiste.creerCaracteristiqueVolee("band",nom_groupe);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT band_name FROM band", "band_name", mon_panel_container_creation.mon_panel_creation_artiste.cb_creation_artiste_groupe);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_creation, "Groupe bien ajout�");}
        }
    });
    mon_panel_container_creation.mon_panel_creation_artiste.b_creation_artiste_ajouter_groupe.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
        	if (!mon_panel_container_creation.mon_panel_creation_artiste.cb_creation_artiste_groupe.getSelectedItem().toString().equals("Choisissez")){
                ...
                JOptionPane.showMessageDialog(mon_panel_container_creation, "Veuillez d'abord selectionner un groupe");
            }}
    });
...
public void gestionClicBoutonsModificationFilm(){
    ...
    mon_panel_container_modification.mon_panel_modification_film.b_modification_film_creer_artiste.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nickname = JOptionPane.showInputDialog(mon_panel_container_modification.mon_panel_modification_film, "Donnez un surnom à l'artiste.");
            System.out.println(nickname);
            if (!nickname.equals(null)){
            mon_panel_container_modification.mon_panel_modification_film.creerArtisteVolee(nickname);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT artist_nickname FROM artist", "artist_nickname", mon_panel_container_modification.mon_panel_modification_film.cb_modification_film_artiste);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_modification, "Artiste bien ajouté aux brouillons");}
        }
    });
    mon_panel_container_modification.mon_panel_modification_film.b_modification_film_creer_genre.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nom_genre = JOptionPane.showInputDialog(mon_panel_container_modification.mon_panel_modification_film, "Donnez un nom au genre.");
            if (!nom_genre.equals(null)){
            mon_panel_container_modification.mon_panel_modification_film.creerCaracteristiqueVolee("genre",nom_genre);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT genre_name FROM genre", "genre_name", mon_panel_container_modification.mon_panel_modification_film.cb_modification_film_genres);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_modification, "Genre bien ajouté");}
        }
    });
    mon_panel_container_modification.mon_panel_modification_film.b_modification_film_creer_tag.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nom_tag = JOptionPane.showInputDialog(mon_panel_container_modification.mon_panel_modification_film, "Donnez un nom au tag ?");
            if (!nom_tag.equals(null)){
            mon_panel_container_modification.mon_panel_modification_film.creerCaracteristiqueVolee("tag",nom_tag);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT tag_name FROM tag", "tag_name", mon_panel_container_modification.mon_panel_modification_film.cb_modification_film_tags);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_modification, "Tag bien ajouté");}
        }
    });
    mon_panel_container_modification.mon_panel_modification_film.b_modification_film_creer_ceremonie.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nom_ceremonie = JOptionPane.showInputDialog(mon_panel_container_modification.mon_panel_modification_film, "Donnez un nom à la cérémonie ?");
            if (!nom_ceremonie.equals(null)){
            mon_panel_container_modification.mon_panel_modification_film.creerCaracteristiqueVolee("ceremony",nom_ceremonie);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT ceremony_name FROM ceremony", "ceremony_name", mon_panel_container_modification.mon_panel_modification_film.cb_modification_film_ceremonie);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_modification, "Ceremoniée bien ajoutée");}
        }
    });
    mon_panel_container_modification.mon_panel_modification_film.b_modification_film_creer_award.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nom_award = JOptionPane.showInputDialog(mon_panel_container_modification.mon_panel_modification_film, "Donnez un nom à la récompense ?");
            if (!nom_award.equals(null)){
            mon_panel_container_modification.mon_panel_modification_film.creerCaracteristiqueVolee("award",nom_award);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT award_name FROM award", "award_name", mon_panel_container_modification.mon_panel_modification_film.cb_modification_film_award);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_modification, "Récompense bien ajoutée");}
        }
    });
    mon_panel_container_modification.mon_panel_modification_film.b_modification_film_creer_studio_production.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nom_pc = JOptionPane.showInputDialog(mon_panel_container_modification.mon_panel_modification_film, "Donnez un nom au producteur.");
            if (!nom_pc.equals(null)){
            mon_panel_container_modification.mon_panel_modification_film.creerCaracteristiqueVolee("pc",nom_pc);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT pc_name FROM pc", "pc_name", mon_panel_container_modification.mon_panel_modification_film.cb_modification_film_studio_production);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_modification, "Producteur bien ajouté");}
        }
    });
    mon_panel_container_modification.mon_panel_modification_film.b_modification_film_ajouter_acteur.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
        	if (!mon_panel_container_modification.mon_panel_modification_film.cb_modification_film_artiste.getSelectedItem().toString().equals("Choisissez")){
    ...
    mon_panel_container_modification.mon_panel_modification_film.b_modification_film_ajouter_genre.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
        	if (!mon_panel_container_modification.mon_panel_modification_film.cb_modification_film_genres.getSelectedItem().toString().equals("Choisissez")){
    ...
    mon_panel_container_modification.mon_panel_modification_film.b_modification_film_ajouter_tag.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
        	if (!mon_panel_container_modification.mon_panel_modification_film.cb_modification_film_tags.getSelectedItem().toString().equals("Choisissez")){
...
mon_panel_container_modification.mon_panel_modification_livre.b_modification_livre_creer_artiste.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nickname = JOptionPane.showInputDialog(mon_panel_container_modification.mon_panel_modification_livre, "Donnez un surnom à l'artiste.");
            System.out.println(nickname);
            if (!nickname.equals(null)){
            mon_panel_container_modification.mon_panel_modification_livre.creerArtisteVolee(nickname);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT artist_nickname FROM artist", "artist_nickname", mon_panel_container_modification.mon_panel_modification_livre.cb_modification_livre_artiste);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_modification, "Artiste bien ajouté aux brouillons");}
        }
    });
    mon_panel_container_modification.mon_panel_modification_livre.b_modification_livre_creer_genre.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nom_genre = JOptionPane.showInputDialog(mon_panel_container_modification.mon_panel_modification_livre, "Donnez un nom au genre.");
            if (!nom_genre.equals(null)){
            mon_panel_container_modification.mon_panel_modification_livre.creerCaracteristiqueVolee("genre",nom_genre);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT genre_name FROM genre", "genre_name", mon_panel_container_modification.mon_panel_modification_livre.cb_modification_livre_genres);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_modification, "Genre bien ajouté");}
        }
    });
    mon_panel_container_modification.mon_panel_modification_livre.b_modification_livre_creer_tag.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nom_tag = JOptionPane.showInputDialog(mon_panel_container_modification.mon_panel_modification_livre, "Donnez un nom au tag ?");
            if (!nom_tag.equals(null)){
            mon_panel_container_modification.mon_panel_modification_livre.creerCaracteristiqueVolee("tag",nom_tag);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT tag_name FROM tag", "tag_name", mon_panel_container_modification.mon_panel_modification_livre.cb_modification_livre_tags);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_modification, "Tag bien ajouté");}
        }
    });
    mon_panel_container_modification.mon_panel_modification_livre.b_modification_livre_creer_ceremonie.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nom_ceremonie = JOptionPane.showInputDialog(mon_panel_container_modification.mon_panel_modification_livre, "Donnez un nom à la cérémonie ?");
            if (!nom_ceremonie.equals(null)){
            mon_panel_container_modification.mon_panel_modification_livre.creerCaracteristiqueVolee("ceremony",nom_ceremonie);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT ceremony_name FROM ceremony", "ceremony_name", mon_panel_container_modification.mon_panel_modification_livre.cb_modification_livre_ceremonie);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_modification, "Ceremoniée bien ajoutée");}
        }
    });
    mon_panel_container_modification.mon_panel_modification_livre.b_modification_livre_creer_award.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nom_award = JOptionPane.showInputDialog(mon_panel_container_modification.mon_panel_modification_livre, "Donnez un nom à la récompense ?");
            if (!nom_award.equals(null)){
            mon_panel_container_modification.mon_panel_modification_livre.creerCaracteristiqueVolee("award",nom_award);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT award_name FROM award", "award_name", mon_panel_container_modification.mon_panel_modification_livre.cb_modification_livre_award);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_modification, "Récompense bien ajoutée");}
        }
    });
    mon_panel_container_modification.mon_panel_modification_livre.b_modification_livre_creer_studio_production.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nom_pc = JOptionPane.showInputDialog(mon_panel_container_modification.mon_panel_modification_livre, "Donnez un nom � l'�diteur.");
            if (!nom_pc.equals(null)){
            mon_panel_container_modification.mon_panel_modification_livre.creerCaracteristiqueVolee("pc",nom_pc);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT pc_name FROM pc", "pc_name", mon_panel_container_modification.mon_panel_modification_livre.cb_modification_livre_studio_production);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_modification, "Editeur bien ajouté");}
        }
    });
    mon_panel_container_modification.mon_panel_modification_livre.b_modification_livre_ajouter_ecrivain.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
        	if (!mon_panel_container_modification.mon_panel_modification_livre.cb_modification_livre_artiste.getSelectedItem().toString().equals("Choisissez")){
    ...
    mon_panel_container_modification.mon_panel_modification_livre.b_modification_livre_ajouter_genre.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
        	if (!mon_panel_container_modification.mon_panel_modification_livre.cb_modification_livre_genres.getSelectedItem().toString().equals("Choisissez")){
    ...
    mon_panel_container_modification.mon_panel_modification_livre.b_modification_livre_ajouter_tag.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
        	if (!mon_panel_container_modification.mon_panel_modification_livre.cb_modification_livre_tags.getSelectedItem().toString().equals("Choisissez")){
...
public void gestionClicBoutonsModificationChanson(){
    ...
    mon_panel_container_modification.mon_panel_modification_chanson.b_modification_chanson_creer_artiste.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nickname = JOptionPane.showInputDialog(mon_panel_container_modification.mon_panel_modification_chanson, "Donnez un surnom à l'artiste.");
            System.out.println(nickname);
            if (!nickname.equals(null)){
            mon_panel_container_modification.mon_panel_modification_chanson.creerArtisteVolee(nickname);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT artist_nickname FROM artist", "artist_nickname", mon_panel_container_modification.mon_panel_modification_chanson.cb_modification_chanson_artiste);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_modification, "Artiste bien ajouté aux brouillons");}
        }
    });
    mon_panel_container_modification.mon_panel_modification_chanson.b_modification_chanson_creer_genre.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nom_genre = JOptionPane.showInputDialog(mon_panel_container_modification.mon_panel_modification_chanson, "Donnez un nom au genre.");
            if (!nom_genre.equals(null)){
            mon_panel_container_modification.mon_panel_modification_chanson.creerCaracteristiqueVolee("genre",nom_genre);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT genre_name FROM genre", "genre_name", mon_panel_container_modification.mon_panel_modification_chanson.cb_modification_chanson_genres);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_modification, "Genre bien ajouté");}
        }
    });
    mon_panel_container_modification.mon_panel_modification_chanson.b_modification_chanson_creer_tag.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nom_tag = JOptionPane.showInputDialog(mon_panel_container_modification.mon_panel_modification_chanson, "Donnez un nom au tag ?");
            if (!nom_tag.equals(null)){
            mon_panel_container_modification.mon_panel_modification_chanson.creerCaracteristiqueVolee("tag",nom_tag);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT tag_name FROM tag", "tag_name", mon_panel_container_modification.mon_panel_modification_chanson.cb_modification_chanson_tags);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_modification, "Tag bien ajouté");}
        }
    });
    mon_panel_container_modification.mon_panel_modification_chanson.b_modification_chanson_creer_ceremonie.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nom_ceremonie = JOptionPane.showInputDialog(mon_panel_container_modification.mon_panel_modification_chanson, "Donnez un nom à la cérémonie ?");
            if (!nom_ceremonie.equals(null)){
            mon_panel_container_modification.mon_panel_modification_chanson.creerCaracteristiqueVolee("ceremony",nom_ceremonie);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT ceremony_name FROM ceremony", "ceremony_name", mon_panel_container_modification.mon_panel_modification_chanson.cb_modification_chanson_ceremonie);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_modification, "Ceremoniée bien ajoutée");}
        }
    });
    mon_panel_container_modification.mon_panel_modification_chanson.b_modification_chanson_creer_award.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nom_award = JOptionPane.showInputDialog(mon_panel_container_modification.mon_panel_modification_chanson, "Donnez un nom à la récompense ?");
            if (!nom_award.equals(null)){
            mon_panel_container_modification.mon_panel_modification_chanson.creerCaracteristiqueVolee("award",nom_award);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT award_name FROM award", "award_name", mon_panel_container_modification.mon_panel_modification_chanson.cb_modification_chanson_award);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_modification, "Récompense bien ajoutée");}
        }
    });
    mon_panel_container_modification.mon_panel_modification_chanson.b_modification_chanson_creer_groupe.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nom_groupe = JOptionPane.showInputDialog(mon_panel_container_modification.mon_panel_modification_chanson, "Donnez un nom au groupe.");
            if (!nom_groupe.equals(null)){
            mon_panel_container_modification.mon_panel_modification_chanson.creerCaracteristiqueVolee("band",nom_groupe);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT band_name FROM band", "band_name", mon_panel_container_modification.mon_panel_modification_chanson.cb_modification_chanson_groupe);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_modification, "Groupe bien ajout�");}
        }
    });
    mon_panel_container_modification.mon_panel_modification_chanson.b_modification_chanson_creer_studio_production.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nom_pc = JOptionPane.showInputDialog(mon_panel_container_modification.mon_panel_modification_chanson, "Donnez un nom au label.");
            if (!nom_pc.equals(null)){
            mon_panel_container_modification.mon_panel_modification_chanson.creerCaracteristiqueVolee("pc",nom_pc);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT pc_name FROM pc", "pc_name", mon_panel_container_modification.mon_panel_modification_chanson.cb_modification_chanson_studio_production);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_modification, "Label bien ajouté");}
        }
    });
    mon_panel_container_modification.mon_panel_modification_chanson.b_modification_chanson_ajouter_interprete.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
        	if (!mon_panel_container_modification.mon_panel_modification_chanson.cb_modification_chanson_artiste.getSelectedItem().toString().equals("Choisissez")){
    ...
    mon_panel_container_modification.mon_panel_modification_chanson.b_modification_chanson_ajouter_genre.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
        	if (!mon_panel_container_modification.mon_panel_modification_chanson.cb_modification_chanson_genres.getSelectedItem().toString().equals("Choisissez")){
    ...
    mon_panel_container_modification.mon_panel_modification_chanson.b_modification_chanson_ajouter_tag.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
        	if (!mon_panel_container_modification.mon_panel_modification_chanson.cb_modification_chanson_tags.getSelectedItem().toString().equals("Choisissez")){
...
public void gestionClicBoutonsModificationArtiste(){
    ...
    mon_panel_container_modification.mon_panel_modification_artiste.b_modification_artiste_creer_pays.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nom_pays = JOptionPane.showInputDialog(mon_panel_container_modification.mon_panel_modification_artiste, "Quel est le pays?");
            if (!nom_pays.equals(null)){
            mon_panel_container_modification.mon_panel_modification_artiste.creerCaracteristiqueVolee("country",nom_pays);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT country_name FROM country", "country_name", mon_panel_container_modification.mon_panel_modification_artiste.cb_modification_artiste_pays);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_modification, "Pays bien ajouté");}
        }
    });
    mon_panel_container_modification.mon_panel_modification_artiste.b_modification_artiste_creer_ceremonie.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nom_ceremonie = JOptionPane.showInputDialog(mon_panel_container_modification.mon_panel_modification_artiste, "Donnez un nom à la cérémonie ?");
            if (!nom_ceremonie.equals(null)){
            mon_panel_container_modification.mon_panel_modification_artiste.creerCaracteristiqueVolee("ceremony",nom_ceremonie);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT ceremony_name FROM ceremony", "ceremony_name", mon_panel_container_modification.mon_panel_modification_artiste.cb_modification_artiste_ceremonie);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_modification, "Ceremoniée bien ajoutée");}
        }
    });
    mon_panel_container_modification.mon_panel_modification_artiste.b_modification_artiste_creer_award.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nom_award = JOptionPane.showInputDialog(mon_panel_container_modification.mon_panel_modification_artiste, "Donnez un nom à la récompense ?");
            if (!nom_award.equals(null)){
            mon_panel_container_modification.mon_panel_modification_artiste.creerCaracteristiqueVolee("award",nom_award);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT award_name FROM award", "award_name", mon_panel_container_modification.mon_panel_modification_artiste.cb_modification_artiste_award);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_modification, "Récompense bien ajoutée");}
        }
    });
    mon_panel_container_modification.mon_panel_modification_artiste.b_modification_artiste_creer_groupe.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
            String nom_groupe = JOptionPane.showInputDialog(mon_panel_container_modification.mon_panel_modification_artiste, "Donnez un nom au groupe.");
            if (!nom_groupe.equals(null)){
            mon_panel_container_modification.mon_panel_modification_artiste.creerCaracteristiqueVolee("band",nom_groupe);
            mes_requetes_events_listener.rechercheValeursComboBox("SELECT band_name FROM band", "band_name", mon_panel_container_modification.mon_panel_modification_artiste.cb_modification_artiste_groupe);
            javax.swing.JOptionPane.showMessageDialog(mon_panel_container_modification, "Groupe bien ajout�");}
        }
    });
    mon_panel_container_modification.mon_panel_modification_artiste.b_modification_artiste_ajouter_groupe.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt){
        	if (!mon_panel_container_modification.mon_panel_modification_artiste.cb_modification_artiste_groupe.getSelectedItem().toString().equals("Choisissez")){
