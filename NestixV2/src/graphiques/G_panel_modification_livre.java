...
public class G_panel_modification_livre extends A_panel_creation_modification {
    ...
    JButton b_modification_livre_valider_modification = new JButton("Créer livre");
    ...
    JList li_modification_livre_liste_ecrivains = new JList<String>();
    JScrollPane sp_modification_livre_liste_genres = new JScrollPane();
    JList li_modification_livre_liste_genres = new JList<String>();
    JScrollPane sp_modification_livre_liste_tags = new JScrollPane();
    JList li_modification_livre_liste_tags = new JList<String>();
